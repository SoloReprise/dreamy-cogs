...
class UniteCog(commands.Cog):
    ...
    async def unite(self, ctx, *, args=None):
        ...
        if args is not None:
            if args.lower().startswith("help"):
                emb = discord.Embed(title="Unite Help", description=unitetext, colour=discord.Embed.Empty)
        ...
        emb = discord.Embed(title=embed_title, description=text, colour=discord.Embed.Empty)
    ...
    async def unitedb(self, ctx, action = None, *, args = None):
        if action is None:
            emb = discord.Embed(title="UniteDB Help", description=unitedbtext, colour=discord.Embed.Empty)
            await ctx.reply(embed=emb)
            return
        ...
        try:
            if action == "create":
                ...
                emb = discord.Embed(title="Caller Created", colour=discord.Embed.Empty)
                emb.set_thumbnail(url=image)
                ...
                emb = discord.Embed(title="Caller Edited", colour=discord.Embed.Empty)
                emb.add_field(name="Name", value=name, inline=False)
                emb.add_field(name="Category", value=category.capitalize(), inline=False)
                emb.add_field(name="Reply Text", value=text, inline=False)
                await result.reply(embed=emb)
