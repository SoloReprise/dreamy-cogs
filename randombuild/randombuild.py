...
class RandomBuild(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.combat_item = ['Botón Escape', 'Humo Ralentizador', 'Cura Total', ...]
        
        self.equipment_items = ['Cinta Fuerte', 'Periscopio', 'Garra Afilada', 'Cascabel Concha', 'Gafas Especiales', 'Energáfono', 'Gafas Elección', ...]
