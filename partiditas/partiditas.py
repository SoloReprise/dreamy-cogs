...
class Partiditas(commands.Cog):
    ...
    async def battle(self, ctx):
        """Comandos para organizar batallas."""
        pass
    ...
    async def battle_inhouse(self, ctx, role: discord.Role, num_teams: int = 2, members_per_team: int = 5):
        ...
        await self._perform_battle_inhouse(ctx, role, num_teams, members_per_team)
    ...
    async def _perform_battle_inhouse(self, ctx, role, num_teams, members_per_team):
        # ... (rest of the code for inhouse scenario)
